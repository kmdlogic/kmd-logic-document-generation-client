...
6. You have existing subscription and document generation configuration in Logic. If not you can go through the document mentioned in previous step.
...
3. In sign configuration creation page the followings can be configured. 
    ...
    <ins>Owner Password</ins> - It is a mandatory field. You can set `Owner password` which can be used to override the privileges of the document once it is generated.
